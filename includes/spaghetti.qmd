...
```{r}
library(here)
knitr::include_graphics(here("includes", "img", "sp.png"))
```
...
-   500g Tomato Sauce (if you want drier, less sauce more paste, up to 340g paste, as little as 200g sauce)

-   200g Tomato Paste (about 1 tube)
...
-   Olive Oil/Butter (1-3 tbsp)

-   Salt/pepper

## Instructions

1.  **Cook aromatics**: In a dutch oven or a pot of choice, add oil and 1 tbsp butter over medium heat. When hot, add onions cook until slightly translucent and softened (around 5-7 minutes). Then add garlic and cook until fragrent (1 minute).
